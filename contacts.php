		...
		<div class="container">
			<div class="row">
				<div class="col l7 s14">
					<h4>Contacts</h4>
					<p>This contact form can be at your service to contact the creator:</p>
				</div>
				<div class="col l4 s6 ergdesign">
					<form action="./mailfunctions/process.php" method="POST">
						...
						<button type="submit" class="btn waves-effect waves-light red white-text lighten-1">Send <i class="material-icons right">send</i></button>
					</form>
				</div>
			</div>
		</div>
